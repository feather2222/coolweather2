...
//    public SwipeRefreshLayout swipeRefreshLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // });
        ...
        drawerLayout=(DrawerLayout)findViewById(R.id.drawber_layout);
    ...
    public void requestWeather(final String weatherId){
        String weatherUrl="http://guolin.tech/api/weather?cityid"+weatherId+"&key=8c67b7c7969d4ac1b9eba117e6e551df";
